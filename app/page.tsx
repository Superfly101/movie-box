...
export default function Home() {
  return (
    <>
      <header className="z-10 w-full flex items-center justify-between absolute top-0 py-2 px-4 md:px-16 lg:px-24">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col gap-[2px] justify-center bg-rose w-8 h-8 p-2 rounded-full">
